        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <Link to={"https://railway.uz/en/"}>
                  <div>
                    <p className="btn text-white bg-blue-600 rounded-lg py-3 px-2  hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0"  >Bosh Wib site</p>
                  </div>
                </Link>
              </div>
            </div>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              <div className="flex flex-col justify-center" style={{ backgroundImage: "url('./images/hero-image.png')" }}>
